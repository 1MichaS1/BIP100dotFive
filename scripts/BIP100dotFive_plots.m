...
figure;
grid on; hold on;
semilogy(time, (d^26).^t,'r','linewidth',3);
semilogy(time, (ymin(1)^26).^t,'b','linewidth',1);
semilogy(time, (ymin(2)^26).^t,'c','linewidth',1);
semilogy(time, (ymin(3)^26).^t,'g','linewidth',1);
semilogy(time, (ymin(4)^26).^t,'m','linewidth',1);
semilogy(time, (ymin(5)^26).^t,'y','linewidth',1);
semilogy(time, (ymin(6)^26).^t,'b','linewidth',1);
semilogy(time, (ymin(7)^26).^t,'c','linewidth',1);
semilogy(time, (1.177).^t,'k-.','linewidth',1);
semilogy(time, (1.414).^t,'k--','linewidth',1);
semilogy(time, (ymax(1)^26).^t,'b','linewidth',1);
semilogy(time, (ymax(2)^26).^t,'c','linewidth',1);
semilogy(time, (ymax(3)^26).^t,'g','linewidth',1);
semilogy(time, (ymax(4)^26).^t,'m','linewidth',1);
semilogy(time, (ymax(5)^26).^t,'y','linewidth',1);
semilogy(time, (ymax(6)^26).^t,'b','linewidth',1);
semilogy(time, (ymax(7)^26).^t,'c','linewidth',1);
xlabel('Year');
